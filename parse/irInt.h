...
typedef struct IrPchoiceStruct *IrPchoice;
...
enum {
	IR_RAWTRANS, IR_IF, IR_DO, IR_P, IR_ASSGN, IR_GOTO, IR_BREAK
...
extern IrPchoice irPchoiceCreate(float, IrStmt, IrPchoice);
...
extern void irPchoiceFree(IrPchoice);
